    ...
    return (
        <div className="bg-black min-h-screen">
            ...
            <div className="flex items-center justify-around">
                ...
                >
                    Gaming <span className="text-white tracking-wider animate-pulse">Zone</span>
                    <FontAwesomeIcon icon={faGamepad} className="ms-5 text-4xl text-pink-500 hover:text-white transition-colors duration-300" />
                </motion.h1>
                <motion.h1
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <Link to={'/login'} className='text-white hover:bg-pink-500 p-2 rounded-md transition-colors duration-300'>Se connecter</Link>
                    <Link to={'/login'} className='text-white bg-pink-500 p-2 rounded-md'>S'inscrire</Link>
                    <button className='text-white' onClick={isOpenModal}>X</button>
                </motion.h1>
            </div>
            ...
            <div className='flex flex-col md:flex-row justify-around items-center pb-10 gap-8 px-4'>
                ...
                >
                    <p className="text-base leading-relaxed tracking-wide">
                        ...
                        <span className="text-xl font-bold text-pink-500">Rejoins la communauté des vrais gamers</span>{" "}
                        <span className="text-pink-500 text-2xl">◥</span>
                        <br /><br />
                        Partage ta passion, fais des échanges, ou défie d'autres joueurs dans un esprit de {" "}
                        <span className="text-pink-400 font-semibold">respect</span> et de {" "}
                        <span className="text-pink-400 font-semibold">fair-play</span>.
                        Ici, le jeu devient une expérience sociale unique.
                        <br /><br />
                        <span className="text-pink-400 font-semibold">Achète, vends, joue et connecte-toi</span> avec des passionnés comme toi !
                    </p>
                ...
                >
                    <img src={img} alt="Gaming Community" className="w-90 h-auto rounded-md object-cover" />
                </motion.div>
            </div>
            ...
            >
                Statistiques de la <span className="text-white animate-pulse">Communauté</span>
            </motion.h2>
