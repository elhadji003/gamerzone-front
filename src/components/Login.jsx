            ...
            <div className="w-full md:w-1/2 bg-gray-900 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="password" className="block text-white font-semibold mb-1">Mot de passe</label>
                            <input
                                id="password"
                                type="password"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full py-2 rounded transition duration-200 ${isLoading
